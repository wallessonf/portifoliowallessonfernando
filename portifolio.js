      ...
      <div class="conteudo-projeto">
        ...
        <div class="links-projeto">
          ...
          <a href="${projeto.github}" target="_blank" class="botao-projeto">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M12 .5C5.65.5.5 5.65.5 12c0 5.1 3.3 9.4 7.9 10.9.6.1.8-.25.8-.55v-2.1c-3.2.7-3.8-1.55-3.8-1.55-.5-1.2-1.2-1.55-1.2-1.55-1-.65.1-.65.1-.65 1.1.1 1.7 1.15 1.7 1.15.95 1.7 2.5 1.2 3.1.95.1-.7.4-1.2.7-1.45-2.55-.3-5.25-1.3-5.25-5.85 0-1.3.45-2.35 1.15-3.2-.15-.3-.5-1.5.1-3.1 0 0 .95-.3 3.15 1.2.95-.25 1.95-.35 2.95-.35 1 0 2 .1 2.95.35 2.2-1.5 3.15-1.2 3.15-1.2.6 1.6.25 2.8.1 3.1.7.85 1.15 1.9 1.15 3.2 0 4.55-2.7 5.55-5.25 5.85.4.35.75 1 .75 2.05v3.05c0 .3.2.65.8.55C20.7 21.4 24 17.1 24 12c0-6.35-5.15-11.5-12-11.5z"/></svg>
            GitHub
          </a>
        </div>
      </div>
...
// Animação de entrada dos cards (AGORA DEPOIS DA GERAÇÃO DOS CARDS)
